                ...
                <div x-data="{ active: 'getting-started' }">
                    <ul class="mb-10">
                        ...
                        <li class="mb-4">
                            ...
                            <ul class="ml-8 mt-2" x-show="active === 'packages'" x-collapse="" style="display: none; height: 0px; overflow: hidden;" hidden="">
                                <li class="mb-2">
                        ...
                        <li class="mb-4">
                            <a href="#" class="text-gray-200 flex items-center gap-2" @click.prevent="active = active === 'advanced' ? null : 'advanced'">
                                <span class="material-symbols-rounded">code</span>
                                Advanced
                                <span class="bg-pink-500/20 text-pink-200 text-xs px-2 py-0.5 rounded-full border border-pink-500/20 ml-auto mr-20">
                                    <span class="material-symbols-rounded text-sm" x-text="active === 'advanced' ? 'expand_less' : 'expand_more'">expand_more</span>
                                </span>
                            </a>
                            <ul class="ml-8 mt-2" x-show="active === 'advanced'" x-collapse="" style="display: none; height: 0px; overflow: hidden;" hidden="">
                                <li class="mb-2">
                                    <a href="#" class="text-gray-400 flex items-center gap-2">
                        ...
                        <li class="mb-4">
                            ...
                            <ul class="ml-8 mt-2" x-show="active === 'support'" x-collapse="" style="display: none; height: 0px; overflow: hidden;" hidden="">
                                <li class="mb-3">
                                    <a href="#" class="text-gray-400 flex items-center gap-2">
            ...
            <div class="w-3/4">
                <div class="bg-slate-950/60 rounded-lg mb-6 border border-pink-500/20 shadow-[0px_-4px_15px_-5px_rgba(139,92,246,0.5),0px_4px_15px_-5px_rgba(236,72,153,0.5)]">
                    <a href="https://moox.heco.si/docsingle?package=job-monitor">
                        <img src="https://moox.heco.si/web/package.jpg" alt="Moox Jobs" class="w-full">
                    </a>
