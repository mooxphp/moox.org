...
@section('content')
          ...
          <div class="relative isolate lg:pt-14">
            <div class="flex justify-center gap-10">
              ...
              <div class="w-3/5 -mt-10 lg:mr-20 lg:pr-20">
                ...
                <h1 class="font-semibold tracking-tight text-balance gradient-text-default sm:text-6xl text-4xl pb-2">
                  The new Laravel CMS
                </h1>
                <p class="mt-8 text-lg font-medium text-pretty text-gray-300 sm:text-xl/8">
                  Moox Content is a Bundle of Laravel and Filament packages<br />
                  to build your own Content Management System.
                </p>
    ...
    <div id="installation" class="max-w-7xl mx-auto text-center my-20">
      ...
      <p class="text-gray-300 text-lg/8 text-pretty">
        Installation is simple. Just install Moox Content using Composer
        and run the Moox installer.<br />
        The installer will guide you through the process of installing the CMS.<br />
          ...
          <div class="grid lg:grid-cols-2 gap-10">
            <div>
              ...
              >
                ...
                >
                  <code id="composer-command">composer require moox/content</code>
                  <button
    ...
    <div id="packages" class="max-w-7xl mx-auto text-center my-20">
        ...
        <br />
        <p class="text-gray-300 text-lg/8 text-pretty">
          Moox Content is a Bundle of 27 Laravel packages.<br />
          A complete Content Management System for Filament.
        </p>
      </div>
