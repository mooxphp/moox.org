    ...
    <div class="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
        ...
        <div id="packages" class="max-w-7xl mx-auto text-center">
            ...
            <p class="text-gray-300 text-lg/8 text-pretty">
              While most Moox packages are FOSS (Free Open Source),<br />
              some of our packages require a license.
            </p>
        </div>
...
<form class="group/tier py-12 sm:py-18">
      ...
      <div class="isolate mx-auto mt-10 grid max-w-md grid-cols-1 gap-8 md:max-w-2xl md:grid-cols-2 lg:max-w-4xl xl:mx-0 xl:max-w-none xl:grid-cols-4">
        <div class="bg-gradient-to-br from-mooxblue to-mooxdark group/tier rounded-3xl p-8 ring-1 ring-gray-200 data-featured:ring-2 data-featured:ring-indigo-600">
          <div class="flex items-center justify-between gap-x-4">
            <h3 id="tier-hobby" class="text-lg/8 font-semibold text-gray-200 group-data-featured/tier:text-gray-200">Launch</h3>
            <p class="rounded-full bg-indigo-600/10 px-2.5 py-1 text-xs/5 font-semibold text-gray-200 group-not-data-featured/tier:hidden">Most popular</p>
          </div>
          <p class="mt-4 text-sm/6 text-gray-400">Start your journey.</p>
          <p class="mt-6 flex items-baseline gap-x-1 group-not-has-[[name=frequency][value=monthly]:checked]/tiers:hidden">
            <span class="text-4xl font-semibold tracking-tight text-gray-400">$9</span>
          ...
          <p class="mt-6 flex items-baseline gap-x-1 group-not-has-[[name=frequency][value=annually]:checked]/tiers:hidden">
            <span class="text-4xl font-semibold tracking-tight text-gray-400">$99</span>
            <span class="text-sm/6 font-semibold text-gray-200">/year</span>
          </p>
        ...
        <div class="bg-gradient-to-br from-mooxblue to-mooxdark group/tier rounded-3xl p-8 ring-1 ring-gray-200 data-featured:ring-2 data-featured:ring-indigo-600">
          <div class="flex items-center justify-between gap-x-4">
            <h3 id="tier-freelancer" class="text-lg/8 font-semibold text-gray-200 group-data-featured/tier:text-gray-200">Orbit</h3>
          ...
          <p class="mt-4 text-sm/6 text-gray-400">For the ambitious.</p>
          <p class="mt-6 flex items-baseline gap-x-1 group-not-has-[[name=frequency][value=monthly]:checked]/tiers:hidden">
            <span class="text-4xl font-semibold tracking-tight text-gray-400">$29</span>
            <span class="text-sm/6 font-semibold text-gray-200">/month</span>
          </p>
          <p class="mt-6 flex items-baseline gap-x-1 group-not-has-[[name=frequency][value=annually]:checked]/tiers:hidden">
            <span class="text-4xl font-semibold tracking-tight text-gray-400">$299</span>
            <span class="text-sm/6 font-semibold text-gray-200">/year</span>
          </p>
        ...
        <div data-featured="true" class="bg-gradient-to-br from-mooxblue to-mooxdark group/tier rounded-3xl p-8 ring-1 ring-gray-200 data-featured:ring-2 data-featured:ring-indigo-600">
          <div class="flex items-center justify-between gap-x-4">
            <h3 id="tier-startup" class="text-lg/8 font-semibold text-gray-200 group-data-featured/tier:text-gray-200">Galaxy</h3>
            <p class="rounded-full bg-indigo-600/10 px-2.5 py-1 text-xs/5 font-semibold text-indigo-600 group-not-data-featured/tier:hidden">Most popular</p>
          </div>
          <p class="mt-4 text-sm/6 text-gray-400">The most wanted.</p>
          <p class="mt-6 flex items-baseline gap-x-1 group-not-has-[[name=frequency][value=monthly]:checked]/tiers:hidden">
            <span class="text-4xl font-semibold tracking-tight text-gray-400">$59</span>
            <span class="text-sm/6 font-semibold text-gray-200">/month</span>
          </p>
          <p class="mt-6 flex items-baseline gap-x-1 group-not-has-[[name=frequency][value=annually]:checked]/tiers:hidden">
            <span class="text-4xl font-semibold tracking-tight text-gray-400">$599</span>
            <span class="text-sm/6 font-semibold text-gray-200">/year</span>
          </p>
        ...
        <div class="bg-gradient-to-br from-mooxblue to-mooxdark group/tier rounded-3xl p-8 ring-1 ring-gray-200 data-featured:ring-2 data-featured:ring-indigo-600">
          <div class="flex items-center justify-between gap-x-4">
            <h3 id="tier-enterprise" class="text-lg/8 font-semibold text-gray-200 group-data-featured/tier:text-gray-200">Infinity</h3>
            <p class="rounded-full bg-indigo-600/10 px-2.5 py-1 text-xs/5 font-semibold text-gray-200 group-not-data-featured/tier:hidden">Most popular</p>
          </div>
          <p class="mt-4 text-sm/6 text-gray-400">Full access to Moox Pro.</p>
          <p class="mt-6 flex items-baseline gap-x-1 group-not-has-[[name=frequency][value=monthly]:checked]/tiers:hidden">
            <span class="text-4xl font-semibold tracking-tight text-gray-400">$99</span>
            <span class="text-sm/6 font-semibold text-gray-400">/month</span>
          </p>
          <p class="mt-6 flex items-baseline gap-x-1 group-not-has-[[name=frequency][value=annually]:checked]/tiers:hidden">
            <span class="text-4xl font-semibold tracking-tight text-gray-400">$999</span>
  ...
  <div id="packages" class="max-w-7xl mx-auto text-center">
    <br />
    <p class="text-gray-300 text-lg/8 text-pretty">
      Instead of one of our plans, you can simply order any<br />
      <a href="/packages?pro=true" class="text-indigo-600">Pro package</a> for <b>$49</b> as a one-time payment<br />
      including one year of basic support.
    </p>
</div>
